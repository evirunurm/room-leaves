		...
		<div class="plant-data">
			...
			<button @click="removeItem($event)" class="remove-button">
				<svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path
						d="M13 10V15M3 5.00002H19L17.42 19.22C17.3658 19.7094 17.1331 20.1616 16.7663 20.49C16.3994 20.8185 15.9244 21 15.432 21H6.568C6.07564 21 5.60056 20.8185 5.23375 20.49C4.86693 20.1616 4.63416 19.7094 4.58 19.22L3 5.00002ZM6.345 2.14702C6.50675 1.80398 6.76271 1.51401 7.083 1.31093C7.4033 1.10784 7.77474 1.00001 8.154 1.00002H13.846C14.2254 0.999821 14.5971 1.10756 14.9176 1.31066C15.2381 1.51376 15.4942 1.80383 15.656 2.14702L17 5.00002H5L6.345 2.14702V2.14702ZM1 5.00002H21H1ZM9 10V15V10Z"
